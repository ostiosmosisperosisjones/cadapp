...
class ViewCube:
    ...
    def _draw_axes(self):
        ...
        glLineWidth(2.0)
        glBegin(GL_LINES)
        glColor4f(0.85, 0.20, 0.20, 1.0); glVertex3f(0,0,0); glVertex3f(1.1,0,0)  # X red
        glColor4f(0.25, 0.50, 0.90, 1.0); glVertex3f(0,0,0); glVertex3f(0,1.1,0)  # Y blue
        glColor4f(0.20, 0.75, 0.30, 1.0); glVertex3f(0,0,0); glVertex3f(0,0,1.1)  # Z green (up)
        glEnd()
        glLineWidth(1.0)
        glEnable(GL_DEPTH_TEST)
